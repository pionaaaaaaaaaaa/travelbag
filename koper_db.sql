...
CREATE TABLE IF NOT EXISTS `kontak` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `fk_kontak_user` (`user_id`),
  CONSTRAINT `fk_kontak_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table koper_db.kontak: ~3 rows (approximately)
INSERT INTO `kontak` (`id`, `nama`, `email`, `subjek`, `pesan`, `user_id`, `sudah_dibaca`, `created_at`) VALUES
	(1, 'siap', 'oke@gmail.com', 'Pertanyaan Produk', 'siapsiap', NULL, 0, '2026-05-01 02:58:12'),
	(2, 'siap', 'oke@gmail.com', 'Pertanyaan Produk', 'asdasd', NULL, 0, '2026-05-01 08:58:55'),
	(3, 'jojo', 'jojo@gmail.com', 'Pertanyaan Produk', 'kenapa ya begini', NULL, 0, '2026-05-01 10:01:56');
...
CREATE TABLE IF NOT EXISTS `ulasan` (
  ...
  KEY `fk_ulasan_user` (`user_id`),
  CONSTRAINT `fk_ulasan_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO `ulasan` (`id`, `produk_id`, `nama`, `rating`, `komentar`, `user_id`, `created_at`) VALUES
	(1, 1, 'Budi Santoso', 5, 'Koper ini luar biasa! Ringan, kuat, dan tampilannya mewah. Sudah dipakai ke Eropa dan kondisinya masih bagus. Highly recommended!', NULL, '2026-04-30 14:15:12'),
	(2, 1, 'Sari Dewi', 5, 'Beli untuk keperluan bisnis, sangat puas. Muat banyak tapi tetap ringan. TSA Lock-nya juga mudah digunakan.', NULL, '2026-04-30 14:15:12'),
	(3, 3, 'Ahmad Fauzi', 5, 'Koper medium terbaik yang pernah saya punya. Harga sebanding dengan kualitas. Roda putarnya halus banget.', NULL, '2026-04-30 14:15:12'),
	(4, 5, 'Rina Kusuma', 5, 'Ini koper impian saya! Beli set 3in1 sangat worth it. Kualitas premium, desain elegan. Siap untuk keliling dunia!', NULL, '2026-04-30 14:15:12'),
	(5, 7, 'Doni Pratama', 5, 'Set koper terlengkap dan terbaik. Harga hemat, kualitas premium. Pengiriman juga cepat dan packaging aman.', NULL, '2026-04-30 14:15:12'),
	(6, 4, 'YASPI', 5, 'yy', NULL, '2026-05-01 03:59:51'),
	(7, 5, 'jojo', 5, 'bagus blabla', NULL, '2026-05-01 09:59:13'),
	(8, 8, 'siapa ya', 4, 'asdasd', NULL, '2026-05-01 10:00:04');

-- Dumping structure for table koper_db.users
...
-- Dumping data for table koper_db.users: ~1 rows (approximately)
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `telepon`, `alamat`, `aktif`, `created_at`, `updated_at`) VALUES
	(1, 'yasfi raharja', 'raharjayasfi@gmail.com', '$2y$10$y3GRCtLDDGmrWs/Q.aEFJubYZwGYRiswGnt.ICjU1j2LW0qNlLhhO', '+6282932452690', NULL, 1, '2026-06-03 21:00:23', '2026-06-03 21:00:23');
